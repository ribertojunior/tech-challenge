...
/** teste de cnpj de https://www.devmedia.com.br/validando-o-cnpj-em-uma-aplicacao-java/22374 */
public class Utils {
  ...
  // criar validações de exame e instituições

  public static boolean validaInstitution(HealthcareInstitution institution) {
    return institution != null
        && validaString(institution.getCnpj())
        && isCNPJ(removeNonNumbers(institution.getCnpj()))
        && validaString(institution.getName());
  }

  public static boolean validaExam(Exam exam) {
    return exam != null
        && validaString(
            exam.getPatientName(),
  ...
  private static boolean validaString(String... strings) {
